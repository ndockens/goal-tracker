  ...
  return (
    <main className="bg-slate-900 flex flex-col items-center min-h-screen p-24">
      <div className="bg-slate-800 flex flex-col items-center p-7 rounded-xl text-center">
        ...
        <input name="emailAddress" type="text" value={account.emailAddress} onChange={onEmailAddressChange} placeholder="Email Address" className="bg-slate-700 min-w-64 mt-4 p-3 rounded-xl text-slate-300 focus:outline-none focus:ring focus:ring-slate-400" />
        ...
        <input name="password" type="text" value={account.password} onChange={onPasswordChange} placeholder="Password" className="bg-slate-700 min-w-64 mt-4 p-3 rounded-xl text-slate-300 focus:outline-none focus:ring focus:ring-slate-400" />
